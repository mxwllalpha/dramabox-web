// Type declarations for lucide-react subpath imports
// This enables tree-shaking while maintaining TypeScript support
...
declare module "lucide-react/dist/esm/icons/flame" {
  import React from "react";
  const Flame: React.FC<React.SVGProps<SVGSVGElement>>;
...
declare module "lucide-react/dist/esm/icons/loader-2" {
  import React from "react";
  const Loader2: React.FC<React.SVGProps<SVGSVGElement>>;
  export default Loader2;
}

declare module "lucide-react/dist/esm/icons/menu" {
  import React from "react";
  const Menu: React.FC<React.SVGProps<SVGSVGElement>>;
  export default Menu;
}
...
declare module "lucide-react/dist/esm/icons/smartphone" {
  import React from "react";
  const Smartphone: React.FC<React.SVGProps<SVGSVGElement>>;
